 ...
 */
public class Drive implements MotorSafety {
     ...
     */
    public Drive(final int leftMotorChannel, final int rightMotorChannel) {
     ...
     */
    public Drive(final int frontLeftMotor, final int rearLeftMotor,
    ...
    public void mecanumDrive_Cartesian(double x, double y, double rotation, double gyroAngle) {
        ...
        double FL,FR,RR,RL;
        double CFL, CFR, CRR, CRL;
        
        FL =  EncoderReg.Call("FL", 1);
        FR =  EncoderReg.Call("FR", 1);
        ...
        m_frontLeftMotor.set((wheelSpeeds[MotorType.kFrontLeft_val] * m_invertedMotors[MotorType.kFrontLeft_val] * m_maxOutput) /* * CFL */, m_syncGroup);
        m_frontRightMotor.set((wheelSpeeds[MotorType.kFrontRight_val] * m_invertedMotors[MotorType.kFrontRight_val] * m_maxOutput)/* * CFR*/, m_syncGroup);
        m_rearLeftMotor.set((wheelSpeeds[MotorType.kRearLeft_val] * m_invertedMotors[MotorType.kRearLeft_val] * m_maxOutput)/* * CRL*/, m_syncGroup);
        m_rearRightMotor.set((wheelSpeeds[MotorType.kRearRight_val] * m_invertedMotors[MotorType.kRearRight_val] * m_maxOutput)/* * CRR*/, m_syncGroup);
